...
if ( ! class_exists( 'WC_Iran_Sefareshi_Shipping' ) ) {
	class WC_Shipping_Iran_Sefareshi extends WC_Shipping_Method {
		...
		public function calculate_shipping( $package ) {
			...
			// round to up for amounts fewer than 1000 tomans
